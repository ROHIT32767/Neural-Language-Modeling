...
class LanguageModel:
    ...
    def train(self, epochs=5, lr=0.001, model_save_path="lstm_model.pt"):
        ...
        self.model = LSTMLanguageModel(len(self.vocab), self.embed_dim, self.hidden_dim)
